// TengaiTest.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "stdafx.h"
#include "TengaiTest.h"
	...
	_In_ int       nCmdShow)			 // 실행한 창의 스타일 옵션(모양 /최소화, 최대화 모양 등)
{
	...
	LoadStringW(hInstance, IDC_TENGAITEST, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TENGAITEST));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TENGAITEST));
	// 윈도우 창이 사용할 아이콘 지정
