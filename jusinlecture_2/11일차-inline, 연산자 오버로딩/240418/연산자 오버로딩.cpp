...
//일반 함수포인터를 조건자로하는 정렬 알고리즘 클래스
//void	Bubble_Sort(int _iArray[], int _iSize, bool (*func)(int _iDst,int _iSrc))

//함수 객체를 조건자로 하는 정렬 알고리즘 클래스
...
int main()
{
	...
	CAscendingSort AESCE;
	//함수포인터를 조건자로
	//Bubble_Sort(iArray, 5, Less);

	//임시 객체를 조건자로
	//Bubble_Sort(iArray, 5, CDescendingSort(10));
	Bubble_Sort(iArray, 5, CAscendingSort());
