...
void CMainGameScene::Initialize()
{
	...
	CZombieMgr::Set_Light_Zombie_Limit_Number(3);
...
void CMainGameScene::Late_Update()
{
	...
	CItemMgr::Spawn(&m_ObjList[OBJ_ITEM], m_ObjList[OBJ_PLAYER].front());
	CBulletItemMgr::Spawn(&m_ObjList[OBJ_BULLET_ITEM], m_ObjList[OBJ_PLAYER].front());
	...
	CCollisionMgr::Collide_Bullet_Item(m_ObjList[OBJ_BULLET_ITEM], m_ObjList[OBJ_PLAYER]);
