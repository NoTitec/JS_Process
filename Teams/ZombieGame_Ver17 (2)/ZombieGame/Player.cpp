...
void CPlayer::Initialize()
{
	...
	m_arrStatus[PLAYER_REBOUND] = false;
	m_fReboundSpeed = 5.f;
...
void CPlayer::Key_Update()
{
	...
	{
		m_arrStatus[PLAYER_REBOUND] = true;
		Create_Bullet();
	}
...
CObj* CPlayer::Create_Barrier()
{
	...
	if (m_arrStatus[PLAYER_BARRIER] && iBarrierCallCount < 30)
	{
		++iBarrierCallCount;
	}
	else
